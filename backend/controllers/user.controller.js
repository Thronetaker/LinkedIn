...
export const sendConnectionRequest = async(req,res)=>{
    ...
    // token - kon bhej rha h
    // connectionId - kisko bhej rha (me)
    ...
    try{
        ...
        // to check  if he had already send a request 
...
export const whatAreMyConnections = async (req,res ) => {
    ...
    try{
        ...
        // Populate => Looks at userId
        // Finds the matching document in User collection
        // Replaces the ObjectId with that user object
